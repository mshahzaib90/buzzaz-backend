    ...
    <div style={{ background: '#fff', color: '#000', minHeight: '100vh' }}>
      ...
      <header style={{ background: '#fff', borderBottom: '1px solid #eee' }}>
        <div style={{
          ...
          <button type="button" className="nav-toggle" onClick={() => setMobileOpen((v) => !v)} aria-label="Toggle menu">
      ...
      <div className={mobileOpen ? 'mobile-menu open' : 'mobile-menu'}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ padding: '8px 16px' }}>
            ...
            {!isAuthenticated ? (
              <>
                <Link to="/register-creator">Sign up as creator</Link>
                <Link to="/register-brand">Sign up as business</Link>
        ...
        <div className="home-two-col" style={{
          ...
          <div>
            ...
            <h3 className="section-title" style={{ marginTop: 10 }}>
              Discover the best influencers for you
            </h3>
