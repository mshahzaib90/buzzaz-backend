...
const InfluencerDashboard = () => {
  ...
  const isProfileComplete = (p) => {
    ...
    const hasNiche = (Array.isArray(p.categories) && p.categories.length > 0) || (Array.isArray(p.niche) && p.niche.length > 0);
    const hasContentStyle = (Array.isArray(p.contentTypes) && p.contentTypes.length > 0) || (Array.isArray(p.contentStyle) && p.contentStyle.length > 0);
    const hasLanguages = (Array.isArray(p.languages) && p.languages.length > 0) || (!!p.language && String(p.language).trim());

    // Pricing & Delivery (Ensure key fields are filled)
    const hasReelPrice = p.reelPrice !== null && p.reelPrice !== undefined && p.reelPrice !== '';
    const hasStoryPrice = p.storyPrice !== null && p.storyPrice !== undefined && p.storyPrice !== '';
    const hasDeliveryTime = !!(p.averageDeliveryTime && String(p.averageDeliveryTime).trim());

    return hasBio && hasLocation && hasNiche && hasContentStyle && hasLanguages && hasReelPrice && hasStoryPrice && hasDeliveryTime;
  };
      ...
      >
        ...
        <Modal.Body>
          <Form>
            ...
            <Row>
              <Col md={6} className="mb-3">
                <MultiSelect
                  ...
                  value={editData.categories || []}
                  onChange={(newValue) => setEditData(prev => ({ ...prev, categories: newValue }))}
              ...
              <Col md={6} className="mb-3">
                <MultiSelect
                  ...
                  value={editData.contentTypes || []}
                  onChange={(newValue) => setEditData(prev => ({ ...prev, contentTypes: newValue }))}
            ...
            <Row>
              <Col md={6} className="mb-3">
                <MultiSelect
                  ...
                  value={editData.languages || []}
                  onChange={(newValue) => setEditData(prev => ({ ...prev, languages: newValue }))}
            ...
            <Row>
              <Col md={6} className="mb-3">
                ...
                <Form.Control
                  ...
                  placeholder="Min"
                  value={editData.priceRangeMin ?? ''}
                  onChange={(e) => setEditData(prev => ({ ...prev, priceRangeMin: e.target.value }))}
                />
              </Col>
              <Col md={6} className="mb-3">
                ...
                <Form.Control
                  ...
                  placeholder="Max"
                  value={editData.priceRangeMax ?? ''}
                  onChange={(e) => setEditData(prev => ({ ...prev, priceRangeMax: e.target.value }))}
                />
              </Col>
            </Row>
            ...
            <Row>
              <Col md={6} className="mb-3">
                ...
                <Form.Control
                  type="number"
                  value={editData.reelPrice ?? ''}
                  onChange={(e) => setEditData(prev => ({ ...prev, reelPrice: e.target.value }))}
                />
              </Col>
              <Col md={6} className="mb-3">
                ...
                <Form.Control
                  type="number"
                  value={editData.storyPrice ?? ''}
                  onChange={(e) => setEditData(prev => ({ ...prev, storyPrice: e.target.value }))}
                />
              </Col>
            </Row>
            ...
            <Row>
              <Col md={6} className="mb-3">
                ...
                <Form.Control
                  type="number"
                  value={editData.eventPrice ?? ''}
                  onChange={(e) => setEditData(prev => ({ ...prev, eventPrice: e.target.value }))}
                />
              </Col>
              <Col md={6} className="mb-3">
                <Form.Label>Multiple Platforms Price</Form.Label>
                <Form.Control
                  type="number"
                  value={editData.multiplePlatformsPrice ?? ''}
                  onChange={(e) => setEditData(prev => ({ ...prev, multiplePlatformsPrice: e.target.value }))}
                />
              </Col>
            </Row>
            ...
            <Row>
              <Col md={6} className="mb-3">
                ...
                <Form.Control
                  ...
                  value={editData.averageDeliveryTime ?? ''}
                  onChange={(e) => setEditData(prev => ({ ...prev, averageDeliveryTime: e.target.value }))}
                />
              </Col>
              <Col md={6} className="mb-3">
                ...
                <Form.Control
                  ...
                  value={editData.deliveryRevisions ?? ''}
                  onChange={(e) => setEditData(prev => ({ ...prev, deliveryRevisions: e.target.value }))}
                />
              </Col>
            </Row>
            ...
            <Row>
              <Col md={6} className="mb-3">
                <Form.Label>Product-based Delivery</Form.Label>
                <Form.Control
                  placeholder="Product-based Delivery"
                  value={editData.deliveryProductBased ?? ''}
                  onChange={(e) => setEditData(prev => ({ ...prev, deliveryProductBased: e.target.value }))}
                />
              </Col>
              <Col md={6} className="mb-3">
                <Form.Label>No-product Delivery</Form.Label>
                <Form.Control
                  placeholder="No-product Delivery"
                  value={editData.deliveryNoProduct ?? ''}
                  onChange={(e) => setEditData(prev => ({ ...prev, deliveryNoProduct: e.target.value }))}
                />
              </Col>
            </Row>

            <div className="mb-3">
              <Form.Label>Outdoor Shoot & Event Attendance Delivery</Form.Label>
              <Form.Control
                placeholder="Outdoor Shoot & Event Attendance Delivery"
                value={editData.deliveryOutdoorShoot ?? ''}
                onChange={(e) => setEditData(prev => ({ ...prev, deliveryOutdoorShoot: e.target.value }))}
              />
            </div>
          </Form>
        </Modal.Body>
        <Modal.Footer>
          <Button variant="light" onClick={handleEditCancelModal}>Cancel</Button>
          <Button variant="primary" onClick={handleSaveEditModal}>Save</Button>
        </Modal.Footer>
      </Modal>
