...
const ChatInterface = ({ currentUser, activeConversationId }) => {
  const [selectedConversationId, setSelectedConversationId] = useState(activeConversationId || null)
  ...
  return (
    <Container fluid className="chat-interface-container">
      <Row className="h-100">
